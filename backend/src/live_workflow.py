...
_SUMMARIZER_SYSTEM = (
    ...
    "and a ratings set that comes out all 'strong' means the provisions were not weighed against "
    "each other — weigh them first, then rate each honestly, even when that leaves several "
