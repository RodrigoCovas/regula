...
_PLANNER_SYSTEM = (
    ...
    "post-incident review, and contract provisions as separate targets. Lift the inventory's "
...
_VERIFIER_SYSTEM = (
    ...
    "scope. When the evidence holds a regime's perimeter provision — the provision that decides "
