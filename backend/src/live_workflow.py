...
_PLANNER_SYSTEM = (
    ...
    "and a third-country transfer target where inference or storage may sit outside the "
    "EEA; a confirmed DORA engagement earns the reporting-machinery duty areas — the "
